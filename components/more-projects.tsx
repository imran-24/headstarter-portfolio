...
export function MoreProjects() {
  return (
    <div className=" flex justify-center text-center w-full">
      ...
      >
        <AceternityLogo />
        <Link href={"/projects"}  className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
          <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">
            <span className="">Exprore projects</span>
          </div>
