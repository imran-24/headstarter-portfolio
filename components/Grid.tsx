...
export const gridItems = [
  {
    ...
    description: "",
    className: "col-span-2 sm:col-span-4 md:col-span-3  row-span-4 justify-start",
  ...
  },
  {
    ...
    title: "",
    description: "",
    className: "border-none col-span-2 sm:col-span-5 md:col-span-6  row-span-4   ",
    imgClassName: "",
  ...
  },
  {
    ...
    title: "Resume",
    description: "",
    className: "sm:col-span-2 lg:col-span-3 sm:row-span-1",
    imgClassName: "",
    titleClassName: "justify-center md:max-w-full text-center",
    img: "",
    spareImg: "",
